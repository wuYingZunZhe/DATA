...
export default {
    data(){
        ...
        my_shadow:[{id:1,title:"我爱源码论坛整站打包"},{id:2,title:"YX语音群呼系统V4.0+安装教程+注册机"},{id:3,title:"12套Laravel框架开发的YLC所有模板均支持BI接口"},{id:4,title:"某一条龙商城程序带数据整站打包"},{id:5,title:"前端Vue+Node+MongoDB高级全栈开发教程完结版"},{id:6,title:"Laravel框架从入门到精通全套商业教程"},{id:7,title:"E站网友分享的几款游戏源码"},{id:8,title:"某源码商城整站打包程序带数据无任何减删"},{id:9,title:"很多人在找的Laravel框架开发的极客展示站带后台管理"},{id:10,title:"目前火爆的网赚项目-粉象生活，零投资、零成本！轻松赚钱，无忧创业！"}]
        }
    }
}
</script>
